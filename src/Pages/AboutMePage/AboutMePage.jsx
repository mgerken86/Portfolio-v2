        ...
        <main id="about">
            <div className="aboutMePage page">
                ...
                <div className='brandStatement'>
                    ...
                    <br /><br />My insatiable curiosity keeps me seeking out challenges that inspire me to find solutions through creativity, critical thinking, perseverance, and collaboration. The speed of evolution in the tech industry excites me, and my passion for knowledge motivates me to adapt my skill-set to match the demands of the industry.
